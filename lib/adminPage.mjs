...
export const NOT_FOUND_PAGE = [
    ...
    "<style>",
    "body{background:rgb(var(--bg));color:rgb(var(--fg));min-height:100vh;min-height:100dvh;display:flex;",
...
function adminCss() {
    return [
        "body{background:rgb(var(--bg));color:rgb(var(--fg));min-height:100vh;padding:28px 20px 140px;}",
        ...
        ".searchBox label{display:block;font-size:12px;letter-spacing:3px;opacity:0.55;margin-bottom:6px;}",
        ".searchBox input{width:100%;}",
        ".searchHint{margin-top:6px;font-size:11px;opacity:0.42;line-height:1.6;}",
        ...
        ".adminTabs .camNode{padding:7px 12px;font-size:12px;letter-spacing:2px;}",
        ...
        "white-space:nowrap;}",
        "th{font-size:11px;letter-spacing:2px;color:rgba(var(--fg),0.45);font-weight:normal;}",
...
function adminBody() {
    return [
        ...
        "<table>",
        "<thead><tr>",
        "<th>ID</th><th>USER_ID</th><th>USERNAME</th>",
