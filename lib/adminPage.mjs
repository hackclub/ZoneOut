...
function adminCss() {
    return [
        ...
        ".adminTabs .camNode.on{border-color:rgba(185,140,255,0.9);",
        "box-shadow:0 0 12px rgba(130,70,200,0.35);}",
...
function adminScript() {
    return [
        ...
        "  suggestionEmptyEl.style.display = rows.length ? 'none' : '';",
        "  suggestionEmptyEl.textContent = 'Nobody has suggested anything yet.';",
