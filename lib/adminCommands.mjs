import { deleteProjectForUser, setBanState, BAN_REASON_MAX } from "./users.mjs";
...
export function parseCommand(line) {
    ...
    throw new CommandError(`unknown command "${match[1]}". Try DELETE, BAN or UNBAN.`);
}
